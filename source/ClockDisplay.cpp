...
void ClockDisplay::Update(FBIO::FrameBuffer* pFB,int pX,int pY,const tm& pCurrentTime,const std::string& pCurrentTemperature)
{
...
void ClockDisplay::DrawTime(FBIO::FrameBuffer* pFB,int pX,int pY,int pHour,int pMinute)
{
    mTimeFont.Printf(pFB,pX + 4,pY + 120,"%02d:%02d",pHour,pMinute);
}

void ClockDisplay::DrawDay(FBIO::FrameBuffer* pFB,int pX,int pY,int pWeekDay,int pMonthDay)
{
